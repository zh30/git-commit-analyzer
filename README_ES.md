...
- Git ≥ 2.30
- Un modelo GGUF local (el programa puede descargar `marzoukbaig14/committed-gguf-0.6b` si no encuentra modelos)
...
2. **Descarga automáticamente el modelo por defecto** (si no se encuentra ninguno):
   - Descarga `marzoukbaig14/committed-gguf-0.6b` desde Hugging Face
